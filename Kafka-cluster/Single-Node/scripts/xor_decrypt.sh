...
DECRYPTED_FILE="$REMOTE_DIR/shared/jaas/kafka_decrypted_jaas.conf"
...
while IFS= read -r line; do
    ...
    dec_pwd=$(java -cp "$REMOTE_DIR/shared/xor_encrypt_decrypt/PasswordUtility.jar:$REMOTE_DIR/shared/xor_encrypt_decrypt/xercesImpl.jar" \
