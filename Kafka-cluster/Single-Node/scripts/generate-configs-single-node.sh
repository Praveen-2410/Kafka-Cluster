...
# Container names 
export SINGLE_NODE_CONTAINER_NAME_1
export SINGLE_NODE_CONTAINER_NAME_2
export SINGLE_NODE_CONTAINER_NAME_3

# Broker 1 
export SINGLE_NODE_BROKER1_INTERNAL_PORT
export SINGLE_NODE_BROKER1_CONTROLLER_PORT
SINGLE_NODE_BROKER1_EXTERNAL_PORT

# Broker 2 
export SINGLE_NODE_BROKER2_INTERNAL_PORT
export SINGLE_NODE_BROKER2_CONTROLLER_PORT
export SINGLE_NODE_BROKER2_EXTERNAL_PORT

# Broker 3 
export SINGLE_NODE_BROKER3_INTERNAL_PORT
export SINGLE_NODE_BROKER3_CONTROLLER_PORT
export SINGLE_NODE_BROKER3_EXTERNAL_PORT
